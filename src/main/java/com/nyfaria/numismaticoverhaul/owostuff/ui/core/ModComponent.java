...
public interface ModComponent extends PositionedRectangle {
     ...
     */
    ModComponent positioning(Positioning positioning);
     ...
     */
    ModComponent margins(Insets margins);
     ...
     */
    default ModComponent sizing(Sizing horizontalSizing, Sizing verticalSizing) {
     ...
     */
    default ModComponent sizing(Sizing sizing) {
     ...
     */
    ModComponent horizontalSizing(Sizing horizontalSizing);
     ...
     */
    ModComponent verticalSizing(Sizing verticalSizing);
     ...
     */
    ModComponent id(@Nullable String id);
     ...
     */
    ModComponent tooltip(@Nullable List<ClientTooltipComponent> tooltip);

    /**
     * Set the tooltip of this component to the given
     * text, without any wrapping applied
     */
    default ModComponent tooltip(@NotNull Collection<net.minecraft.network.chat.Component> tooltip) {
     ...
     */
    default ModComponent tooltip(@NotNull net.minecraft.network.chat.Component tooltip) {
        var components = new ArrayList<ClientTooltipComponent>();
     ...
     */
    ModComponent zIndex(int zIndex);
     ...
     */
    ModComponent cursorStyle(CursorStyle style);
