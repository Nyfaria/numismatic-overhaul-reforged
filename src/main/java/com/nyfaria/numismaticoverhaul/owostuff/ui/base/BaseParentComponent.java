 ...
 * especially {@link com.nyfaria.numismaticoverhaul.owostuff.ui.container.WrappingParentComponent} is often useful
 */
public abstract class BaseParentComponent extends BaseComponent implements ParentComponent {
    ...
    @Override
    public void onChildMutated(ModComponent child) {
        var previousSize = this.fullSize();
        this.inflate(this.space);
     ...
     */
    protected void mountChild(@Nullable ModComponent child, Size space, Consumer<ModComponent> layoutFunc) {
